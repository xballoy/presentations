...
Si vous ne le diriez pas à un inconnu, ne le tapez pas dans un chat IA.

<!--
Transition après la démo 3. La lettre utilisait un nom et une adresse qui semblent réels, donc le
signaler explicitement avant que le public ne pense qu'il est normal de faire pareil avec ses propres données.
-->
